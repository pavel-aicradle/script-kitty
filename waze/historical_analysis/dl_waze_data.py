...
# This script grabs files from s3 and syncs them with a machine in the directory you run from.

import subprocess


dates = ["2018-01-02/", "2018-01-03/", "2018-01-04/", "2018-01-05/", "2018-01-06/", "2018-01-07/", "2018-01-08/",
...
for date in dates:
	print(subprocess.run(f"sudo aws s3 sync s3://banjo-waze-rss-files/production/{date} ./{date}", shell=True, check=True))
